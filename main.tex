...
\begin{abstract}
Selecting the right convolution for a spherical neural network is a delicate tradeoff between efficiency and  exactitude with respect to equivariance. DeepSphere, as a graph based method strikes as a controllable balance between these two desiderata. 
