...
rebuttal:
\begin{itemize}
	\item \mdeff{Why two definitions of rotations, $R(g)$ and $\mathcal{R}_g$?} [Martino]
...
\begin{wrapfigure}{r}{5cm}
	\centering
	\includegraphics[width=\linewidth]{d_iA_i}
...
% \mdeff{Can we avoid to introduce general manifolds and stay on the sphere?} \nati{yes}
...
% Increasing the graph resolution of the graph of \citet{khasanova2017sphericalcnn} does not seem to improve its equivariance.
