...
\begin{itemize}
	...
	\item figure that shows the three samplings? (suggested by reviewer \#2)
	...
	\item Restructure the method section to show how the cost is reduced to $\bO(pkn)$: (i) discretization ($n$ vertices), (ii) sparsification ($k$ neighbors), (iii) reduction of the class of operators / filters (polynomial order $p$).
...
Our code is available at \url{https://github.com/deepsphere}.
\end{abstract}
...
%and Andreas Loukas for having processed the GHCN data.
