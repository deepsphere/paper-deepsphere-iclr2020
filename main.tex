...
% 	\item climate spherical figure: inputs with TC and AR labels superimposed [Frédérick]
	...
	\item Sampling, discretization, or pixelization of the sphere? Be consistent.
\end{itemize}
}
\newpage
...
To demonstrate the flexibility of modeling the discretized sphere by a graph, we collected historical measurements from weather stations scattered across the Earth.\footnote{\url{https://www.ncdc.noaa.gov/ghcn-daily-description}}
...
There are \todo{xx} stations in total.
