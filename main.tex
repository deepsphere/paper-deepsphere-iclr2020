...
\begin{tabular}{l|c c c c}
        ...
        \cmidrule(lr){2-5}
        \multicolumn{1}{l}{Method} & BG & TC & AR & mean \\ \hline
        %Mudigonda et al. & 97 & 74 & 65 & 78.67 & - & - & - \\
        Jiang et al. & 97 & 94 & 93 & 94.67\\
        Jiang (bsize 64) & 95.2 & 93.9 & 95.7 & 94.95\\
        % 328'339
        Cohen et al. (S2R) & 97.3 & 97.8 & 97.3 & 97.5\\
        Cohen et al. (R2R) & 97.4 & 97.9 & 97.8 & 97.7\\ \hline
        DS (ico) & $98.2\pm 0.5$ & $97.4\pm 1.1$ & $97.7\pm 0.7$ & $97.8\pm 0.3$ \\
        %DS (non-weighted) & 99.8 & 73.3 & 90.2 & 87.81 & 79.29 & 97.93 & 88.61 & 30ms & 3h50m\\
        DS (non-weighted) & $99.7\pm 0.1$ & $69.2\pm 3.7$ & $94.5\pm 2.9$ & $87.8\pm 0.5$ \\ \hline
        % DS (non-weighted) & 99.6 & 66.6 & 96.1 & 87.41\\ \hline
        % 12'926'432
...
\begin{tabular}{l|c c c c c}
        ...
        \multicolumn{1}{l}{Method} & TC & AR & mean & inference & training \\ \hline
        %Mudigonda et al. & 97 & 74 & 65 & 78.67 & - & - & - \\
        Jiang (bsize 64) & 11.08 & 65.21 & 38.41 & 10.2 ms & 10h14m\\
        % 328'339
        Cohen et al. (S2R) & - & -& 68.6 & - & - \\
        Cohen et al. (R2R) & - & -& 75.9 & - & -\\ \hline
        DS (ico) & $58.88\pm 3.17$ & $95.41\pm 1.51$ & $77.15\pm 1.94$ & 25 ms & 25h \\
        DS (non-weighted) & $80.86\pm 2.42$ & $97.45\pm 0.38$ & $89.16\pm 1.37$ & 30 ms & 13h \\ \hline
        % DS (non-weighted) & 83.66 & 97.57 & 90.62 & 30ms & 13h\\ \hline
        % 12'926'432
        % non-weighted: accuracy (99.28, 33.60, 93.56, mean: 75.4819);AP (46.15, 93.87, mean: 70.01)
        % weighted:        accuracy (96.52, 97.13, 97.59, mean: 97.08); AP (49.71, 89.23, mean: 69.47)
        DeepSphere (equi non-weighted) & 55.53 & 94.85 & 75.19 & 567 ms & 48h
    \end{tabular}
    \caption{Climate pattern segmentation average precision for positive classes and mean as wel, plus speed performance for inference (one training pass for one instance)  and training time.}
\end{table}
...
\subsubsection*{dense regression - future temperature estimation}
...
\subsubsection*{global regression - day in year estimation}
* days represented by a sine to represent the periodic nature of the year.\\
* task too easy, features already periodic\\
...
30 epochs
\subsubsection*{Jiang Icosahedron}
encoder:\\
\begin{dmath}
