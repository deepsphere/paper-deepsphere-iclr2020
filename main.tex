...
\begin{abstract}
% We have to submit soon... The last sentence is a bit disconnected. Yep
Designing a convolution for a spherical neural network requires a delicate tradeoff between efficiency and rotation equivariance. % exactitude with respect to equivariance.
...
In particular, comparison with previous work on shape classification and climate event detection suggests that anisotropic filters are an unnecessary price to pay. 
