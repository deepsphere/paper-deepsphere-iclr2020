...
The polynomials are all of order $K=4$ and the number of channels per layer is $16, 32, 64, 128, 256$, respectively.
...
A GAP and a fully connected layer with softmax follow.
The polynomials are all of order $K=5$ and the number of channels per layer is $16, 32, 64, 64, 64$, respectively.
...
\begin{table}
    ...
    \begin{tabular}{l c c}
		...
		\citet{perraudin2019deepspherecosmo}, FCN variant, $k=8$ & 83.8 & 187\,ms \\ % & 1\,h\,45
...
The polynomials are all of order $K=4$.
