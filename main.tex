...
% 	\item climate spherical figure: inputs with TC and AR labels superimposed [Frédérick]
	...
	\item add figure with optimal kernel widths
...
\end{equation}
where $K$ is the polynomial order (which corresponds to the filter's size) and $\alpha_i$ are the coefficients to be optimized during training.
...
\subsubsection*{HEALPix architecture}
