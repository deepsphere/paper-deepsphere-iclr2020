...
%\begin{wrapfigure}{r}{0.5\linewidth}
	\centering
	\includegraphics[height=6em]{lamp_000018}
	\includegraphics[height=6em]{lamp_000018_sphere_nobar}
	\caption{Example of a 3D object represented as a spherical depth map. T}
	\label{fig:depthmap}
%\end{wrapfigure}
\end{floatingfigure}
...
\todo{Graph, network architecture (info in the appendix, set the notation in the method section) and hyper-parameters. Or leave in appendix.}
...
% x times faster
As the information in those spherical maps resides in the low frequencies (\todo{figure}), reducing the equivariance error didn't translate into improved performance.
