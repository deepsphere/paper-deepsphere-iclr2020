...
\begin{align*}
	...
	&\leq  d^{(n)} \max _{y\in \S^2} C_{\phi^t_y} ,\\
\end{align*}
...
\end{align*}
where $C_{K^t_y}$ is the Lipschitz constant of $x\rightarrow K^t(x;y)$. We can observe that such constant does not depend on $y$:
