...
\paragraph{Sampling} 
As the graph convolution act on a sampled version of the signal $\b{f}$ and the rotation on its continuous counterpart $f$, we first need to define a sampling operator.
