...
* compare with improved graph (Nside=32) $\Rightarrow$ no improvement if information in low frequencies, do an SHT \\
...
\begin{table}
	...
	\cite{jiang_spherical_2019} \emph{rerun} & 94.95 & 38.41 & 10 & 10h14m\\
	% 328'339
	\cite{cohen_gauge_2019} (S2R) & 97.5 & 68.6 & - & -\\
	\cite{cohen_gauge_2019} (R2R) & 97.7 & 75.9 & - & -\\ \hline
	% unknown
	DeepSphere (weighted) & $97.8\pm 0.3$ & $77.15\pm 1.94$ & 25 & 25h \\
	DeepSphere (non-weighted) & $87.8\pm 0.5$ & $89.16\pm 1.37$ & 33 & 13h35\\
	% 12'926'432
	\end{tabular}
